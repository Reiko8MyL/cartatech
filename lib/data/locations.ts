...
export const LOCATION_DATA: LocationData = {
  ...
  "Chile": {
    ...
    "Valparaíso": ["Valparaíso", "Viña del Mar", "Quilpué", "Villa Alemana", "Quillota", "San Antonio", "Los Andes"],
    "Región Metropolitana": ["Santiago", "Puente Alto", "Maipú", "La Florida", "San Bernardo", "Las Condes", "Providencia", "Ñuñoa", "La Reina", "Macul", "Peñalolén", "San Miguel"],
    "O'Higgins": ["Rancagua", "San Fernando", "Pichilemu", "Rengo", "Machalí"],
    "Maule": ["Talca", "Curicó", "Linares", "Constitución", "Molina"],
    "Ñuble": ["Chillán", "Bulnes", "San Carlos", "Quirihue"],
    "Bío Bío": ["Concepción", "Talcahuano", "Los Ángeles", "Coronel", "Lota", "Chiguayante", "San Pedro de la Paz"],
    "Araucanía": ["Temuco", "Villarrica", "Pucón", "Angol", "Lautaro", "Victoria"],
    "Los Ríos": ["Valdivia", "La Unión", "Río Bueno", "Paillaco"],
    "Los Lagos": ["Puerto Montt", "Osorno", "Castro", "Ancud", "Puerto Varas", "Calbuco"],
    "Aysén": ["Coyhaique", "Puerto Aysén", "Cochrane"],
